                    ...
                    Brand.find(function (err,brand) {
                        Brand.findOne({_id:result.nhanhieu},function (err,brandsp) {
                            Binhluan.find({sanpham:id},function (err,binhluan) {
                                ...
                                curpage="";
                                res.render('product/product-detail',{title:'eShop-'+result.ten,product:result,product_loai:result2,loai:result1,relatedproducts:relatedproductresult,current_cate:result2.ten,binhluan:binhluanChuck,brand:brand,pages:arrPage,brandsp:brandsp,user:req.user});
                            });
                        });
                    });
                });
