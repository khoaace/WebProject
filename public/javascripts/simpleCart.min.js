...
function loadTable() {
    ...
    for(var i=0;i<arrProduct.length;i++)
    {
        ...
        tbProductCount.innerHTML = '<input type="number" name="productCount" id="productCount'+row+'" class="cart_quantity_input" value="'+arrProduct[i].count+'" onchange="SomeScriptMethod('+row+','+arrProduct[i].count+');" onkeyup="this.value=this.value.replace(/[^\\d]/,\'\')">';
